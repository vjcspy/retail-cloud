...
export class RetailConfigActions {
  ...
  static ACTION_LOADED_DEPEND = 'ACTION_LOADED_DEPEND';
  
  isLoadedDepend(isLoadedDepend, dispatch: boolean = true): Action {
    const action = {type: RetailConfigActions.ACTION_LOADED_DEPEND, payload: {isLoadedDepend}};
