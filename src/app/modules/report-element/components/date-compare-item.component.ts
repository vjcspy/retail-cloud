...
export class CloudReportDateCompareItemComponent implements OnInit,AfterViewInit {
    ...
    ngAfterViewInit(): void {
        ...
        $("#selectWeekData")['combodate']({
                                              ...
                                              value: this.service.viewDataFilter['compare_from'] ?
                                                this.service.viewDataFilter['compare_from'].format('DD-MM-YYYY') :
        ...
        switch (type) {
          ...
          case "last_from" :
            ...
            if (this.value == 'hour') {
              ...
              this.model['dateEnd']   =
                moment(this.model['dateStart']).add(data_compare_count, this.value).endOf(this.value).format("YYYY-MM-DD H:mm:ss");
            } else {
              this.model['dateEnd'] =
